...
LIBMEDIA_SVC_EXPORT_API int media_svc_connect(MediaSvcHandle **handle, uid_t uid, bool need_write);
LIBMEDIA_SVC_EXPORT_API int media_svc_disconnect(MediaSvcHandle *handle);
LIBMEDIA_SVC_EXPORT_API int media_svc_get_user_version(MediaSvcHandle *handle, int *user_version);
