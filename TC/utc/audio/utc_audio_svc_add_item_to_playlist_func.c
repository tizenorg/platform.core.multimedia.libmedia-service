...
/**
* @file 	utc_audio_svc_add_item_to_playlist_func.c
...
#include "utc_audio_svc_add_item_to_playlist_func.h"
...
* @par ID	utc_audio_svc_add_item_to_playlist_func_01
* @param	[in] &player = handle of player to be populated
* @return	This function returns zero on success, or negative value with error code
*/
void utc_audio_svc_add_item_to_playlist_func_01()
{
...
* @par ID	utc_audio_svc_add_item_to_playlist_func_02
* @param	[in] &player = NULL
* @return	error code on success
*/
void utc_audio_svc_add_item_to_playlist_func_02()
{
	int ret = AUDIO_SVC_ERROR_NONE;
	int plst_index = -1;
	...
	{
		dts_fail("audio_svc_add_item_to_playlist","add item to playlist should be failed because of the invalid parameter.");
	}
