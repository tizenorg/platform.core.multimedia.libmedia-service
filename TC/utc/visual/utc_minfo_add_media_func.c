...
* @brief 	This is a suit of unit test cases to test minfo_add_media API function
* @author 		
* @version 	Initial Creation Version 0.1
* @date 	2010-10-13
*/

#include "utc_minfo_add_media_func.h"
...
{	
	...
	{
		UTC_MM_LOG("Add a media content to media table should be failed because of the file_url NULL.");
		UTC_MINFO_FINALIZE()
		tet_result(TET_FAIL);
	}
