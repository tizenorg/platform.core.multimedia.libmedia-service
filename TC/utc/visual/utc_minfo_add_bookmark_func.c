...
/**
* @file 	utc_minfo_add_bookmark_func.c
* @brief 	This is a suit of unit test cases to test minfo_add_bookmark API function
* @author 		
* @version 	Initial Creation Version 0.1
* @date 	2010-10-13
*/

#include "utc_minfo_add_bookmark_func.h"
...
void utc_minfo_add_bookmark_func_01()
{
	...
	{
		UTC_MM_LOG( "unable to add a bookmark to a media file. error code->%d", ret);
	UTC_MINFO_FINALIZE()
		tet_result(TET_FAIL);
		return;
	} else {
...
{	
	...
	{
		UTC_MM_LOG("add a bookmark to a media file should be failed because of the media_id parameter -1.");
	UTC_MINFO_FINALIZE()
		tet_result(TET_FAIL);
	}
